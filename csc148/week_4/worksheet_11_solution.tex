...
\begin{enumerate}[a.]
    ...
    \begin{mdframed}
        ...
        \begin{enumerate}[1.]
            \item Determine the cost of \textit{s2.push(s1.pop())}

            \bigskip

            First, determine the cost of \textit{s2.push(s1.pop())}.
            ...
            Using this fact, we can conclude \textit{s2.push(s1.pop())} has cost of 1.

            \end{mdframed}

            \item Determine the cost of loop 1.

            \bigskip

            Second, we need to determine the total cost of loop 1.
            ...
            \item Show that for the second loop, 0 steps are taken.
