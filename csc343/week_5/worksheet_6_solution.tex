...
\begin{enumerate}[1.]
    ...
    Query Q \#1: The address of movie producers whose movie was created in 2019
    ...
    // Example 1
    SELECT address
    FROM Studio, Movies, MovieExec
    WHERE producerC# = cert# year=2019
    \end{lstlisting}

    \bigskip

    Query Q \#2: The networth of movie producers whose movie was created in 2019
