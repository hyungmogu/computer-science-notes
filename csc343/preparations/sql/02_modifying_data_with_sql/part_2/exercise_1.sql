...
We have an eCommerce database and it has a products table. It has the columns
id, name, description and price.

The warehouse is closing down. There's a clearance sale and all products need to
be priced 0.99.
"""
...
Update all contacts to have the first name of 'Mystery' and last name of
'Person'.
"""
