...
Find all the matches in the results table where 'Hessle' was playing away as the
away team and if they played on or after October 1st 2015. Date format is 'YYYY-MM-DD'.
"""
