...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        \begin{center}
        \includegraphics[width=0.7\linewidth]{images/worksheet_9_solution_15.png}
        \end{center}
    ...
    \end{lstlisting}
        ...
        \item Converting schema in figure 20 to DTD

        \bigskip

        \begin{center}
        \includegraphics[width=0.6\linewidth]{images/worksheet_9_solution_16.png}
        \end{center}
    \end{enumerate}
