...
\begin{enumerate}[1.]
    ...
    \end{lstlisting}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item the entire expression is false if there is at least one item where expression1 makes expression2 false
                \end{itemize}
                \item \textbf{Syntax:} some \textit{variable} in \textit{expression1} satisfies \textit{expression2}
                \begin{itemize}
                    \item the entire expression is false if \underline{all} items in expression1 makes expression2 false
                \end{itemize}
            \end{itemize}
