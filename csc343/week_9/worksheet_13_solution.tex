            ...
            \begin{enumerate}[1.]
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item $\{S\}^+ = \{S\}$
                        \item $\{G\}^+ = \{G\}$
                        \item $\{C,H\}^+ = \{C,T,H,R\}$ : $CH \to T$, $CH \to R$
                        \item $\{C,R\}^+ = \{C,T,R\}$ : $CR \to T$
                        \item $\{C,S\}^+ = \{C,S,T,G\}$ : $CS \to T$, $CS \to G$
                        \item $\{C,G\}^+ = \{C,T,G\}$ : $CG \to T$
                        \item $\{H,R\}^+ = \{H,R,C,T\}$ : $HR \to C$, $HR \to T$
                        \item $\{H,S\}^+ = \{C,T,H,R,S,G\}$ : $HS \to C$, $HS \to T$, $HS \to R$, $HS \to G$
                        \item $\{H,G\}^+ = \{H,G\}$
                        \item $\{R,S\}^+ = \{R,S\}$
                        \item $\{R,G\}^+ = \{R,G\}$
                        \item $\{C,H,R\}^+ = \{C,T,H,R\}$ : $CHR \to T$
                        \item $\{C,H,S\}^+ = \{C,T,H,R,S,G\}$ : $CHS \to R$, $CHS \to T$
                        \item $\{C,H,G\}^+ = \{C,T,H,G\}$ : $CHG \to T$
                        \item $\{C,R,S\}^+ = \{C,S,G,R\}$ : $CRS \to G$
                        \item $\{C,R,G\}^+ = \{C,T,R,G\}$ : $CRG \to T$
                        \item $\{C,S,G\}^+ = \{C,T,S,G\}$ : $CSG \to T$
                        \item $\{H,R,S\}^+ = \{C,T,H,R,S,G\}$ : $HRS \to T$, $HRS \to C$, $HRS \to G$
                        \item $\{H,R,G\}^+ = \{C,T,H,R,G\}$
                        \item $\{H,S,G\}^+ = \{C,T,H,R,S,G\}$
                        \item $\{R,S,G\}^+ = \{R,S,G\}$
                        \item $\{C,H,R,S\}^+ = \{C,T,H,R,S,G\}$
