...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        The lossless decompostion of $R$ are: $S_1(C,T): C \to T $, $S_2(H,R,C): HR \to C$, $S_3(H,T,R): HT \to R$, $S_4(H,S,R): HS \to R$, $S_5(C,S,G): CS \to G$

        \bigskip

        All of the relations are in BCNF.
        ...
        \begin{itemize}
            \item The conclusion is based on the second step of 3NF, how each relation's
            attributes are $XA$ of $X \to A$.
            \item This is the part where should be clarified by professor.
        \end{itemize}
    ...
    \begin{enumerate}[a)]
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                So, $IS \to Q$ can't be simplified to this.
        ...
        \item $S_1(S,D): S \to D$, $S_2(I,B): I \to B$, $S_3 (I,S,Q): IS \to Q$,
        $S_4(B,O): B \to O$
    ...
    Given the decomposed table $S_1(A,B,C)$, $S_2(A,D)$, $S_3(A,D,E)$, we have
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        $a$ & $b_1$ & $c_1$ & $d$ & $e_2$\\
        \hline
        $a$ & $b$ & $\color{red}c$ & $d_2$ & $e$\\
        \hline
    \end{tabular}

    \bigskip

    \underline{\textbf{Step 2 ($C \to B$):}}
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        A & B & C & D & E\\
        \hline
        $a$ & $b$ & $c$  & $\color{red}d$ & $e_1$\\
        \hline
        $a$ & $b_1$ & $c_1$ & $d$ & $e_2$\\
        \hline
        $a$ & $b$ & $\color{red}c$ & $\color{red}d$ & $e$\\
        \hline
    \end{tabular}

    \bigskip

    Since $a,b,c,d,e$ exists, by Chase Test, the decomposition of $R(A,B,C,D,E): AB \to C, C \to B, A \to D$
    has a lossless join.
