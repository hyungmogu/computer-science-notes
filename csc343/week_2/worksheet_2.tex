...
\begin{enumerate}[1.]
    ...
    \begin{center}
    \includegraphics[width=0.\linewidth]{images/worksheet_2_1.png}
    \includegraphics[width=0.\linewidth]{images/worksheet_2_2.png}
    \includegraphics[width=0.\linewidth]{images/worksheet_2_3.png}
    \includegraphics[width=0.\linewidth]{images/worksheet_2_4.png}
    \end{center}
