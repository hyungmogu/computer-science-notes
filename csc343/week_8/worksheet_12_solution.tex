...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[i)]
        ...
        \begin{enumerate}[a)]
            ...
            $\{B\}^+ = \{A,B,C,D\}$, so we have $B \to A$, $B \to C$, $B \to D$

            \bigskip

            $\{C\}^+ = \{A,B,C,D\}$, so we have $C \to A$, $C \to B$, $C \to D$

            \bigskip

            $\{D\}^+ = \{A,B,C,D\}$, so we have $D \to A$, $D \to B$, $D \to C$
            ...
            $\{B,C\}^+ = \{A,B,C,D\}$, so we have $BC \to A$, $BC \to B$, $BC \to C$, $BC \to D$

            \bigskip

            $\{B,D\}^+ = \{A,B,C,D\}$, so we have $BD \to A$, $BD \to B$, $BD \to C$, $BD \to D$

            \bigskip

            $\{C,D\}^+ = \{A,B,C,D\}$, so we have $CD \to A$, $CD \to B$, $BD \to C$, $CD \to D$
