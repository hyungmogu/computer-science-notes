    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{enumerate}[1.]
                ...
                \begin{itemize}
                    \item Verify that the problem exhibits optimal substructure
                    ...
                    \begin{itemize}
                        \item Let $A'_{kj}$ be another mutually compatible activities in $S_{kj}$ where $\lvert A'_{kj} \rvert > \lvert A_{kj} \rvert$.
                    \end{itemize}
                \end{itemize}
