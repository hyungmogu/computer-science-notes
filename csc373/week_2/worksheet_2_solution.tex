        ...
        \begin{itemize}
            ...
            \begin{enumerate}[1.]
                ...
                \begin{itemize}
                    ...
                    \item Typically have top-down design
                    \begin{itemize}
                        \item Make a choice and then solve a subproblem
                        \item Dynamic programming has bottom-up approach: Solve subproblems before making a choice
                    \end{itemize}
                    \item Steps
                    ...
                    \begin{enumerate}[1.]
                        ...
                        \item Find activities that start after $a_1$ finishes
                    \end{enumerate}
                \end{itemize}
