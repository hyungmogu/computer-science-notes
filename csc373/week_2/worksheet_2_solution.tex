...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{enumerate}[1)]
            \item consider the left most point in the set $x$
            \item compare $x$ with $x_{\text{max}}$ in $[x_{\text{min}}, x_{\text{max}}]$. If $x > x_{\text{max}}$, then
            replace $x_{\text{max}}$ in $[x_{\text{min}}, x_{\text{max}}]$ with $x$.
        \end{enumerate}
