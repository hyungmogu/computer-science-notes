...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Activities $a_i$ and $a_j$ are \textbf{compatible}, if intervals $[s_i, f_i)$ and $[s_j, f_j)$
            don't overlap
            \item Assume that activities are sorted in monotonically increasing order of finish time
