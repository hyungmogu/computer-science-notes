...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[1.]
        ...
        \quad Here, the number of leaves is:
        ...
        Allowing a lot of estimation, we have

        \begin{align}
            \mathcal{O}(\text{cost at depth} \times \text{depth}) = \mathcal{O}(n \cdot 2^{n-1})
        \end{align}
        ...
        \underline{Guess:} $T(n) \leq cn2^{n-1} - dn$
