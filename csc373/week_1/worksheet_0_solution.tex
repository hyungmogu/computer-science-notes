...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{enumerate}[1.]
            ...
            \begin{align}
            \sum\limits_{i=0}^{\log_4 n} c(3/16)^in^2 &= cn^2 \cdot \sum\limits_{i=0}^{\log_4 n} (3/16)^i\\
            &= cn^2 \cdot \sum\limits_{i=0}^{\log_4 n} (3/16)^i\\
            &= cn^2 \cdot \sum\limits_{i=0}^{\infty} (3/16)^i & [\text{since $n$ is asympt. large}]\\
            &= cn^2 \Bigl(\frac{1}{1 - (3/16)} \Bigr) & [\text{Since $\sum\limits_{i=0}^{\infty} ar^i = \frac{a}{1 - r}$}]
            \end{align}
