...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[1.]
        ...
        The tree has $n^{\lg 3}$ leaves. So,

        \bigskip

        \begin{align}
            T(n) &= cn \cdot \sum\limits_{i=0}^{\lg_2(n) - 1} (3/2)^i + \Theta(n^{\lg 3})\\
            &= cn \cdot \Bigl( \frac{(3/2)^{\lg_2(n)} - 1}{(3/2) - 1} \Bigr) + \Theta(n^{\lg 3})\\
            &= 2cn \cdot \Bigl((3/2)^{\lg_2(n)} - 1 \Bigr) + \Theta(n^{\lg 3})
        \end{align}
