...
\begin{enumerate}[1.]
    ...
    And we verify it using subtitution method.

    \bigskip

    Let the guess be $T(n) \leq cn^2 \lg^2 n$.

    \bigskip

    I need to show the guess holds in the recurrence $T(n) = 4T(\frac{n}{2}) + n^2 \lg n$.
    ...
    \begin{align}
        T(n) &= T(\frac{n}{2}) + n^2 \lg (n)\\
        &\leq 4c\bigl( \frac{n^2}{4} \bigr) \lg^2 (\frac{n}{2}) + n^2 \lg (n)\\
        &= cn^2 \lg^2 (\frac{n}{2}) + n^2 \lg (n)\\
        &\leq cn^2 \lg^2 (n) + n^2 \lg (n)\\
        &\leq cn^2 \lg^2 (n) + n^2 \lg (n)\\
        &= cn^2 \lg^2 (n) & [\text{Since $cn^2 \lg^2 (n)$ dominates $n^2 \lg (n)$}]
    \end{align}
    ...
    \begin{mdframed}
        ...
        And \color{red}I will\color{black}\:verify it using subtitution method.
        ...
        \begin{align}
            T(n) &= T(\frac{n}{2}) + n^2 \lg (n)\\
            &\leq 4c\bigl( \frac{n^2}{4} \bigr) \lg^2 (\frac{n}{2}) + n^2 \lg (n)\\
            &= cn^2(\lg(n) - 1)\lg (\frac{n}{2}) + n^2 \lg n\\
            &= cn^2 \lg(n) \lg (\frac{n}{2}) - cn^2 \lg (\frac{n}{2}) + n^2 \lg n\\
            &= cn^2\lg(n) \lg (\frac{n}{2}) - cn^2(\lg n - 1) + n^2 \lg n\\
            &= cn^2\lg(n) \lg (\frac{n}{2}) - cn^2(\lg n + cn^2 + n^2 \lg n\\
            &= cn^2\lg(n) \lg (\frac{n}{2}) - n^2 \lg n (c - 1) + cn^2\\
            &= cn^2(\lg(n) \lg (\frac{n}{2}) + 1) - n^2 \lg n (c - 1)\\
            &= cn^2\lg(n) \lg (\frac{n}{2}) - n^2 \lg n (c - 1) & [\text{Since $\lg(n) \lg (\frac{n}{2})$ over 1}]\\
            &\leq cn^2\lg^2(n) - n^2 \lg n (c - 1)\\
            &\leq cn^2\lg^2(n)
        \end{align}
        \color{black}
