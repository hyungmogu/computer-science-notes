...
\begin{enumerate}[1.]
    ...
    Let a linear program has $n$ variables and $m$ constraints.

    \bigskip

    I need to give an upper bound on the number of variables and constraints in the resulting
    linear program.

    \bigskip

    In conversion to standard form, the areas that affect the number of constraints
    and variables are:
