...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        When $x_i \neq x_j$, $<x_i,..,x_j>$ is not a part of longest palindromic subsequence.

        \bigskip

        Using this fact, we can write the value of $T[i,j]$ depends on the longest palindromic subsequence of $<x_i,...,x_j>$.
        ...
        \begin{mdframed}
        The recursive formula for $T[i,j]$ is
