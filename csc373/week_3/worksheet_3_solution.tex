            ...
            \begin{enumerate}[1.]
                ...
                \begin{enumerate}[1)]
                    ...
                    \begin{itemize}
                        ...
                        \begin{align}
                            M[2,3] &= \min_{1 \leq k \leq 2} (M[2,2] + M[3,3] + p_{i-1}p_kp_j)\\
                            &= \min_{1 \leq k \leq 2} (0 + 0 + p_1p_2p_3)\\
                            &= \min_{1 \leq k \leq 2} (0 + 0 + 10 \cdot 3 \cdot 12)\\
                            &= 360
                        \end{align}
                        ...
                        \begin{align}
                            M[3,4] &= \min_{1 \leq k \leq 2} (M[3,3] + M[4,4] + p_{i-1}p_kp_j)\\
                            &= \min_{1 \leq k \leq 2} (0 + 0 + p_2p_3p_4)\\
                            &= \min_{1 \leq k \leq 2} (0 + 0 + 3 \cdot 12 \cdot 20)\\
                            &= 720
                        \end{align}
