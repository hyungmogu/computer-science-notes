...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{center}
            \includegraphics[width=0.8\linewidth]{images/worksheet_4_solution_39.png}
            \includegraphics[width=0.8\linewidth]{images/worksheet_4_solution_40.png}
            \end{center}
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{center}
            \includegraphics[width=0.8\linewidth]{images/worksheet_4_solution_41.png}
            \end{center}
        \end{itemize}
    \end{itemize}
