...
\begin{enumerate}[1.]
    ...
    \begin{center}
    \includegraphics[width=0.5\linewidth]{images/worksheet_4_solution_64.png}
    \end{center}
    ...
    \begin{itemize}
        \item What does the value in vertex mean? Can it be any values?
        ...
        \begin{enumerate}[1.]
            ...
            \begin{enumerate}[a)]
                ...
                \begin{itemize}
                    ...
                    \begin{center}
                    \includegraphics[width=0.5\linewidth]{images/worksheet_4_solution_62.png}
                    \end{center}
                \end{itemize}

                \item Convert each $\hat{\delta(u,v)}$ to $\delta(u,v)$
                \begin{itemize}
                    \item \textbf{Formula:} $\delta(u,v) = \hat{\delta}(u,v) + h(v) - h(u)$
                \end{itemize}
