...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        First, I need to evaluate the number of iterations in loop 2 per iteration of loop 1.
        ...
        the loop ends is $k = \lceil \frac{i}{3} \rceil$.

        \bigskip



        The $k$ many iterations in inner loop is triggered per iteration of outerloop.
