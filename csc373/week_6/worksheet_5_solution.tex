...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[1.]
        ...
        \begin{align}
            \sum\limits_{v \in V} f(u,v) &= 0 & [\text{Since  $(u,v) \notin E$ for all $v \in V$}]\\
            &= \sum\limits_{v \in V} f(v,u) & [\text{By flow conservation}]
        \end{align}

        \bigskip

        Then it follows from the capacity constraint $\forall a,b \in V$, $0 \leq f(a,b)$
        that $f(u,v) = f(v,u) = 0$ for all $v \in V$
