...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Detects maximum flow from start vertex to sink vertex in a graph
            \end{itemize}
        ...
        \begin{enumerate}[1)]
            ...
            \begin{center}
            \includegraphics[width=\linewidth]{images/worksheet_5_solution_10.png}
            \end{center}
            ...
            \begin{center}
            \includegraphics[width=\linewidth]{images/worksheet_5_solution_11.png}
            \end{center}
        \end{enumerate}
    \end{itemize}
