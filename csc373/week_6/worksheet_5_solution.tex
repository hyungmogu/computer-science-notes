...
\begin{enumerate}[1.]
    ...
    \begin{align}
        ...
        &= \lvert E \rvert \sum\limits_{e \in F'} c_e + \sum\limits{e \in F'} 1\\
    ...
    At * we used that all capacities are integers and thus the capacity of $(S', V\setminus S)$
    is at least one smaller than the capacity of the cut $(S, V\setminus S)$.
