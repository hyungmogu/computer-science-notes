...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item It feels like I am trying to ride a bicycle when I can ride a tricycle without parents' help.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Is a maximum capacity of flow that can cross the cut from source to sink
        \end{itemize}

        \item \textbf{Minimum Cut of a network}

        \begin{itemize}
            \item Is a cut whose capacity is minimum over all cutes of the network
        \end{itemize}
    \end{itemize}
