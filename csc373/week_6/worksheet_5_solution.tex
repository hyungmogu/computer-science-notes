...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \item \textbf{Flow Network (cont'd)}
        ...
        a flow in $G$. We note that if $(u,v) \in E$, then $(v,u) \notin E$ and $f(v,u) = 0$. Thus,
        the definition
        ...
        I see there are two cases. I will prove each separately.

        \bigskip

        \begin{enumerate}[1.]
            \item \textbf{Case 1 (when $(u,v) \notin E$):}
            ...
            \begin{align}
                \sum\limits_{v \in V} f \uparrow f' (u,v) &= 0 & [\text{By augmentation def.}]\\
                &= \sum\limits_{v \in V} f(u,v) & [\text{Since there is no flow}]\\
                &= \\
            ...
            \item \textbf{Case 2 (when $(u,v) \in E$):}
            \bigskip

            Here, assume $(u,v) \in E$.
