...
\begin{mdframed}
    ...
    \begin{enumerate}[1.]
        ...
        \item Show that there is a minimum element in set satisfying $x^3 + 3y^3 = 9z^3$,
        using well-ordering principle

        \begin{mdframed}
        Then, by principle of well-ordering, we can conclude there exists values
        $x_0,y_0,z_0$ satisfying the equation $x^3 + 3y^3 = 9z^3$.
        \end{mdframed}
