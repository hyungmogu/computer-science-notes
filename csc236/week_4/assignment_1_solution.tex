...
\begin{enumerate}[a.]
    ...
    \begin{mdframed}
        ...
        Let $b'$ be an arbitrary bipartite graph with 235 vertices. Assume $P(235)$. That is,
        ...
        \begin{enumerate}[1.]
            \item State that $b$ results in maximum number of edges.
            ...
            \begin{mdframed}
            Since we know $b$ results in maximum number of edges
            \end{mdframed}
        \end{enumerate}
