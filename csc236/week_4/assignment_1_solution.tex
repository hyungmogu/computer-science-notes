        ...
        \begin{enumerate}[1.]
            ...
            \begin{enumerate}[1.]
                ...
                \begin{itemize}
                    ...
                    \begin{mdframed}
                    We know the edges of vertex $v$ runs from $v$ to each vertex
                    in the smaller partition.

                    \bigskip

                    Since the smaller partition has at most $\frac{n+1}{2} = k$,
                    vertices, we can write the vertex $v$ has at most $k$ vertices.
                    \end{mdframed}
                    ...
                    \item Conclude $b$ has no more than $\frac{(2k)^2}{4}$ edges. \textit{Needs fix**}

                    \begin{mdframed}
                    Finally, by combining the two together, we can conclude $b$ has no more than
