...
\begin{enumerate}[1.]
    ...
    Assume all arrive jobs at the same time.
    ...
    \begin{itemize}
        \item \textbf{Part 1:} Calculating turnaroundtime with FIFO schedulers
        ...
        \item \textbf{Part 2:} Calculating turnaroundtime with SJF schedulers
