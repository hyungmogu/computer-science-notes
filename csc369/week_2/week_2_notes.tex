...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            it should be able to enter in a
        \end{itemize}
        \item Bounded Waiting (No Starvation)
        \begin{itemize}
            \item If some thread $T$ is waiting on the CS, then there is a limit
            on the number of times other threads can enter CS before this thread is
            denied access
        \end{itemize}
        \item Performance
        \begin{itemize}
