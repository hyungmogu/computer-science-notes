...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        \color{red}A user level process needs to be able to call trap so trap instruction
        is executed to switch into kernel mode (it's a user-level operation)\color{black}
        \end{mdframed}
        ...
        \begin{enumerate}[1)]
            \item StackOverflow, What is the difference between Trap and Interrupt?, \href{https://stackoverflow.com/questions/3149175/what-is-the-difference-between-trap-and-interrupt}{link}
        \end{enumerate}
