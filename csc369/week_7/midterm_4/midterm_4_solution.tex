            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \begin{enumerate}[1.]
                        ...
                        \textbf{inode number})
                        \begin{itemize}
                            \item root directory has no is no parent directory
                            \item root directory's \textbf{inode number} is 2 (for UNIX file systems)
                        \end{itemize}

                        \item Read the \textbf{inode} of root directory
                        \item Once its \textbf{inode} is read, read through its directory data (\textbf{data blocks})
                ...
                \begin{itemize}
                    \item [correction]: Read through directory data until the inode number of \texttt{foo} is found
                    \item \texttt{open} reads target inode to memory
                \end{itemize}
            \end{itemize}
