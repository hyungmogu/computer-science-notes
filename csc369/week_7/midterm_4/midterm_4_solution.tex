...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        Since \texttt{mygrade-copy2.txt} is a soft link that's linked to
        \texttt{mygrade-copy.txt}, the removal of file \texttt{mygrade-copy.txt}
        would result in texttt{mygrade-copy2.txt} becoming a dangling reference.
    \end{enumerate}
