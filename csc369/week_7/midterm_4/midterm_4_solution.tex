...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        all to journal before writing to the file system, metadata journaling writes data block to file system
        first before bitmap and inode are written to journal of which later written to the file system.

        \bigskip

        Based on this fact, we can conclude metadata journaling doesn't provide full consistency.
        \bigskip
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Steps [Images need correction]
            ...
            \begin{itemize}
                \item [\color{blue}Question\color{black}] The only difference in metadata journaling seems to be
                that the data block is written first. How does it eliminate double write in data journaling?
