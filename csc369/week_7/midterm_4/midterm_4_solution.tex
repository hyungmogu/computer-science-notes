            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item If Inode cannot be fixed easily, it is removed, and bitmap is updated
                    \end{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item Count is fixed if there is mismatch
                        \item Inode is moded to \texttt{lost+found} directory if no directory refers to it
                    \end{itemize}
                    \item \textbf{Duplicates}
                    \begin{itemize}
                        \item Duplicate pointers (i.e. two different inodes pointing to same block) is checked
                        \item Solved by either removing one inode, or creating a copy for each
                    \end{itemize}
