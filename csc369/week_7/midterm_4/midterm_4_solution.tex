...
\begin{enumerate}[1.]
    ...
    \begin{enumerate}[a)]
        ...
        So, wehn removed, \texttt{mygrade-copy2.txt} still points to the inode of \texttt{mygrade.txt}.
        ...
        FS frees the file's inode, and its data blocks by setting them free in bitmap.
