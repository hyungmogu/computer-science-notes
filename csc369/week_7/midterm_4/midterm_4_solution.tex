        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{enumerate}[1.]
                    ...
                    \item \textbf{Free:} Some time later, mark the transaction free in the journal by updating the
                    journal superblock
                \end{enumerate}
                ...
                \begin{itemize}
                    \item Crash happens while at step 1 $\to$ skip pending update
                    \item Crash happens in between step 2 and 3 $\to$ replay the update and attempt to write blocks
                    to final desination
