...
\begin{itemize}
    ...
    \begin{itemize}
        \item [\color{blue}Question\color{black}] Why does I/O time on textbook say \texttt{13.2ms}?
        \item \textbf{I/O Time for Random Workload}

        \begin{itemize}
            \item $T_{seek} = 9ms$ (From the manufacturer specification)
            \item $T_{rotation} = 4ms$
            ...
            \begin{align}
                T_{transfer} &= \frac{\text{Size of Block}}{\text{Max Transfer}}\\
                &= \frac{4069 \text{ bytes}}{105 \text{ MB/s}}\\
                &= \frac{4069 \cancel{\text{ bytes}} \cdot \cancel{\text{second}}}{1.05 \times 10^8 \cancel{\text{ bytes}}} \cdot \frac{1000 \cancel{\text{ miliseconds}}}{\cancel{\text{second}}} \cdot \frac{1000 \text{ microseconds}}{1 \cancel{\text{milisecond}}}\\
                &\approx 38.75 \text{ microseconds}
            \end{align}
        \end{itemize}
