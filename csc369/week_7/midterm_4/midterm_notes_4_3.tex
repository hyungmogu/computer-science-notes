...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{align}
                \frac{\text{size of block}}{\text{Max Transfer}} &= \frac{4069 \text{ bytes}}{125 \text{ MB/s}}\\
                &= \frac{4069 \text{ bytes} \cdot \text{second}}{1.25 \times 10^8 \text{ MB}} \cdot \frac{1000 \text{ miliseconds}}{\text{second}}
            \end{align}
        \end{itemize}
