...
\begin{itemize}
    ...
    \begin{itemize}
        \item [\color{blue}Question\color{black}] Why does manufacturer time on textbook say \texttt{13.2ms}?
        ...
        \begin{itemize}
            ...
            \item $T_{transfer} = 30 microsecs$ (I need to know where this is coming from)
        \end{itemize}
