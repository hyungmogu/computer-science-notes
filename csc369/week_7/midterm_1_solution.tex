    ...
    \begin{enumerate}[a)]
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item the OS takes a physical resource (processor, memory or disk) and
                transforms it into a more general, powerful, easy-to-use virtual form of itself
            \end{itemize}
            ...
            \begin{itemize}
                ...
                \begin{enumerate}[1.]
                    \item \textbf{Limited direct execution} is a mechanism of CPU virtualization

                    \begin{itemize}
                        \item Idea: First make sure to setup hardwre to limit what the process can do without OS assistance
                        (trap handler, timer interrupt), and just run the program on the CPU
                    \end{itemize}

                    \item \textbf{Scheduling policies} are polices of CPU virtualization
