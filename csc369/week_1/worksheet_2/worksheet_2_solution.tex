...
\begin{enumerate}[1.]
    ...
    I need to write how the resulting final process trees will look like as the
    percentage changes. Here I ran command (\texttt{./fork.py -s 10 -a 20 -f 0.1} and \texttt{./fork.py -s 10 -a 20 -f 0.9})
