...
\begin{itemize}
    ...
    \item [\color{blue}Question\color{black}] The textbook says $T_{transfer}$ is 30 microsec,
    but when doing the calculation with supplied equation, it returns 32 microseconds. Did the
    author estimated the value of $T_{transfer}$?
    \item [\color{blue}Question\color{black}] What is the process when deleting file/directory works in UNIX
...
\subsection{Sector:}
\begin{center}
    \includegraphics[width=0.4\linewidth]{../images/midterm_4_solution_59.png}
\end{center}
\begin{itemize}
...
\subsection{Calculating I/O Time}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $T_{rotation} \approx 4.15ms$
        ...
        \begin{align}
            \frac{\text{Time (ms)}}{\text{Rotation}} &= \frac{1 \cancel{minute}}{7200 Rot.} \cdot \frac{60 \cancel{seconds}}{1 \cancel{minute}} \cdot \frac{1000 ms}{1 \cancel{seconds}}\\
        ...
        But because disk encounters half rotation on average, we have

        \bigskip

        \begin{align}
            T_{rotation} \approx 4.15ms
        \end{align}

        \item $T_{transfer} \approx 38 microsecs$
        ...
        \begin{align}
            T_{transfer} &= \frac{\text{Time (ms)}}{\text{1 Request}}\\
            &= \frac{4 \cancel{\text{ KB}}}{\text{request}} \cdot \frac{1 \cancel{\text{ MB}}}{1000 \cancel{\text{ KB}}} \cdot \frac{1 \cancel{\text{ second}}}{105 \text{ MB}} \cdot \frac{1000 \text{ ms}}{1 \cancel{\text{ second}}}\\
            &\approx 38 \text{ microseconds}
        \end{align}
    \end{itemize}
    ...
    \begin{itemize}
        \item Is the max-transfer rate
        \item For Barracuda it's $105 \text{ MB/s}$
        \item For Cheetah its $125 \text{ MB/s}$
    \end{itemize}
\end{itemize}
...
\subsection{SPTF: Shortest Positioning Time First}
