...
\begin{enumerate}[a.]
    ...
    \begin{mdframed}
        ...
        Let $n,m \in \mathbb{N}$. Assume $n \mid m$ and assume there exists $r,s \in \mathbb{Z}$,
        $rn + sm = 1$.

        \bigskip

        We need to show $n$ is not prime. That is, there exists $a,b \in \mathbb{N},\:
        n \mid a \land n \mid b \land n \mid ab$.
