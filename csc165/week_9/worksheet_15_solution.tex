...
\begin{enumerate}[a.]
    ...
    Let $n \in \mathbb{N}$, $lst_{upper} = [1,2,3,\dots,n-1,1]$ and
    $lst_{lower} = [1,2,3,\dots,1,n-1]$.

    \bigskip

    We will prove this statement by finding the upper and lower bound of this
    input family, and combine them together.

    \bigskip

    \textbf{Part1 (Upper bound):}
