...
\begin{enumerate}[a.]
    ...
    \begin{proof}
        ...
        iterations, we can conclude the line \textbf{$x$ // 2} will run twice.
        ...
        Because we know \textbf{$x \mod 2$ == 0} is true in first iteration, we
        can conclude the line \textbf{$x$ // 2} will run.
