...
\begin{enumerate}[a.]
    ...
    the length of the set of verticies is even. (i.e. $\forall G = (V,E), Bipartite(G) \Rightarrow \forall k \in \mathbb{N}, C = \{v_0,\dots,v_k\} \subseteq V \land Cycle(C,G) \Rightarrow \exists d \in \mathbb{Z}, k = 2d$)
    ...
    \begin{mdframed}
        ...
        \begin{enumerate}[1.]
            ...
            We need to show $C=v_1,v_2,v_3$ is not a cycle.
