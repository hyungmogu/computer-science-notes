    ...
    \begin{mdframed}
        ...
        \begin{enumerate}[1.]
            ...
            \begin{itemize}
                ...
                \begin{mdframed}
                The assumption tells us $v_3 = v_0$.

                \bigskip

                Then, since $v_0,v_2$ are in $V_1$ and the second property of bipartite
                graph tells us that no two verticies in $V_1$ are adjacent, we
                can conclude $v_0,v_2$ are not adjacent.
                \end{mdframed}
                ...
                Finally, we need to show $v_2, v_3$.
