...
\begin{enumerate}[a.]
    ...
    the length of the set of verticies is even. (i.e. $\forall G = (V,E), Cycle(G) \land Bipartite(G) \Rightarrow \exists k \in \mathbb{Z}, \lvert Cycle(G) \rvert = 2k$)
    ...
    \begin{mdframed}
        ...
        Let $C = v_0,...,v_k$ be a cycle in $G$. Without loss of generality,
        assume $v_0 \in \mathbb{V_1}$.

        \bigskip

        We will prove that $k$ is even by using induction on $k$.
        ...
        \begin{enumerate}[1.]
            ...
            Let $k = 3$. Assume $C$ is a cycle in $G$ and $G$ is bipartite.

            \bigskip

            We need to show the length of the cycle $\lvert C \rvert$ is even.
            ...
            in $G$, and $G$ is bipartite, and $\exists d \in \mathbb{Z}, k = 2d$.

            \bigskip

            We need to prove $k+1$ is even.
