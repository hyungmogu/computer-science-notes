...
\begin{enumerate}[a.]
    ...
    (i.e. $\forall G = (V,E),\\ Bipartite(G) \Rightarrow \forall k \in \mathbb{N}, C = \{v_0,\dots,v_k\} \subseteq V \land Cycle(C,G) \Rightarrow \exists d \in \mathbb{Z}, k = 2d$)
    ...
    \begin{mdframed}
        ...
        assume $v_0 \in \mathbb{V_1}$. [Needs improvement*]
