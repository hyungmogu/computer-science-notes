...
\end{lstlisting}
    ...
    I need to write the value of the string \texttt{s1} after the execution of the following statements:

    \bigskip

    \begin{center}
    \includegraphics[width=0.5\linewidth]{images/review_6_solution_6.png}
    \end{center}
