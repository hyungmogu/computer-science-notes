...
\begin{enumerate}[1.]
    ...
    I need to modify project 5 from chapter 7 satisfying the following requirements:

    \begin{itemize}
        \item The program includes the function \texttt{int comput\_scrabble\_value (const char *word)} that returns
