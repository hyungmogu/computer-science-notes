...
\end{lstlisting}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{center}
            \includegraphics[width=0.8\linewidth]{images/review_7_solution_11.png}
            \end{center}

            \item feels as if union is used as an efficient version of switch

            (could python's type-independent variable also use union?)
        \end{itemize}
    \end{itemize}
...
\begin{enumerate}[1.]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Sharing Function Prototypes}
        ...
        \item \textbf{Building a Multiple-File Program}
        \begin{itemize}
            \item Basic Command

            \bigskip

            \texttt{gcc -o justify justify.c line.c word.c}
            ...
            \begin{center}
            \includegraphics[width=\linewidth]{images/review_7_solution_16.png}
            \end{center}

            \begin{itemize}
                \item Compile using the command \texttt{make $<$OUTPUT NAME$>$}
    ...
    See file \texttt{question\_25.c}.

    \item

    See file \texttt{question\_26.c}.

    \item

    See file \texttt{question\_27.c}.
    ...
    \begin{enumerate}[1)]
        \item Githib (William Gherman), c-solutions (Chapter 5 Project 9), \href{https://github.com/williamgherman/c-solutions/blob/master/05/projects/09/9.c}{link}
    \end{enumerate}
\end{enumerate}
