...
\begin{lstlisting}[language=c]
    ...
    int main(void) {
        int day;
        struct date d1 = {3, 1, 2019};
        struct date d2 = {2, 2, 2019};

        day = compare_dates(d1,d2);
...
\begin{lstlisting}[language=c]
    ...
    void reduce (struct fraction *f) {
        ...
        if (fPtr->numerator >= fPtr->denominator) {
            gcd = fPtr->denominator;
        } else {
            gcd = fPtr->numerator;
        }

        while (gcd > 0) {
            if ((fPtr->numerator % gcd == 0) &&
                (fPtr->denominator % gcd == 0)) {
                break;
            }
        ...
        fPtr->denominator = fPtr->denominator/gcd;
        fPtr->numerator = fPtr->numerator/gcd;
    }
\end{lstlisting}
...
\begin{lstlisting}[language=c]
    ...
    int main(void) {
        ...
        struct fraction f1 = {5, 4}, f2 = {10, 5}, f3;
