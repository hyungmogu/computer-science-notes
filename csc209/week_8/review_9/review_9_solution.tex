...
\end{lstlisting}
    ...
    \begin{enumerate}[a)]
        ...
        Some compilers print -1 instead of 1 because it's value of sign is set at different value.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Programs that deal with memory at low level must be
                aware of the order in which bytes are stored
            \end{itemize}
