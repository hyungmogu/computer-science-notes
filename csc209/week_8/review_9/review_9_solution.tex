...
\end{lstlisting}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item C doesn't allow address operator \texttt{\&} to a bit field
            \end{itemize}
        ...
        \begin{itemize}
            ...
            \item 0 bit-field padding pushes non-empty bit-field as far as possible
            in left, or right or both directions
